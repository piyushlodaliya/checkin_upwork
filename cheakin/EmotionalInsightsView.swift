...
struct EmotionalInsightsView: View {
    ...
    let mockInsights = [
        ...
        EmotionLog(time: "17:00", emotion: "crying", aiInsight: "Emotional dip detected, reach out to friends"),
        EmotionLog(time: "20:00", emotion: "flushed", aiInsight: "Evening anxiety, try some breathing exercises"),
        EmotionLog(time: "23:00", emotion: "gasp", aiInsight: "Late night surprise or shock moment"),
        EmotionLog(time: "02:00", emotion: "grimacing", aiInsight: "Sleep disruption noted, consider wind-down routine")
    ]
